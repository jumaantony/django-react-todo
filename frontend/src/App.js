...
export default class App extends Component {
  constructor(props){
    ...
    this.state = {
      // viewComplted represents the status of the task.
      ...
      //empty list that stores all completed taks
      taskList: []
    };
  }
  ...
  // refreshList() method is used to fetch the list of tasks from the backend.
  refreshList = () => {
    axios
